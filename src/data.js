...
const data = [
    {
        ...
        characterBio: {
            name: "Ryu",
            image: "./img/street-fighter-2/ryu/hero-image--ryu.png",
            origin: "Japan",
            flag: "./img/street-fighter-2/ryu/flag--japan.webp",
            ...
            special: [
                {
                    name: "Shoryuken",
                    combo: [r, dL, r, sp],
                    animation: "./img/street-fighter-2/ryu/ryu-sf2-shoryuken.gif"
                },
                {
                    name: "Hadouken",
                    combo: [r, dR, d, dL, l, sp],
                    animation: "./img/street-fighter-2/ryu/gif--combo-example--hadouken.gif"
                }
            ],
            light: [
                {
                    name: "Jab Punch",
                    combo: [r, lt],
                    animation: "./img/street-fighter-2/ryu/ryu-sf2-a1.gif"
                },
                {
                    name: "Reverse Punch",
                    combo: [l, r, lt],
                    animation: "./img/street-fighter-2/ryu/ryu-sf2-a2.gif"
                }
            ],
            medium: [
                {
                    ...
                    animation: "./img/street-fighter-2/ryu/gif--combo-example--hurricane-kick.gif"
                },
                {
                    name: "Spinning Back Kick",
                    combo: [l, r, md],
                    animation: "./img/street-fighter-2/ryu/ryu-sf2-a5.gif"
                }
            ],
            heavy: [
                {
                    name: "Uppercut",
                    combo: [d, u, hv],
                    animation: "./img/street-fighter-2/ryu/ryu-sf2-c3.gif"
                },
                {
                    name: "Spinning Low Kick",
                    combo: [dL, dL, hv],
                    animation: "./img/street-fighter-2/ryu/ryu-sf2-c6.gif"
                }
            ],
        }
    }
